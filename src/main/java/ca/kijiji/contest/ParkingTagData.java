...
public class ParkingTagData {
	...
	public String streetNameFromLocationStringUsingRegex(String str) {
		...
		final String streetTypePatternString = 
				"(AV|AVE|BL|BLVD|CIR|CIRCLE|CIRCUIT|COURT|CR|CRCL|CRT|CRES|CT|DR|DRIVE|GARDEN|GARDENS|GDNS|GRV|GRDNS|GT|HILL|HTS|KEEP|LANE|LN|LWN|MEWS|PARKWAY|PATH|PKWY|PL|PLACE|POINT|PROMENADE|PTWY|QUAY|RD|ROAD|SQ|ST|STREET|TER|TRAIL|TRL|VISTA|WAY|WOOD)";
